...
func TestUmbrellaAPI_IsHealthySuccess(t *testing.T) {
	...
	umbrellaAPI, err := NewUmbrellaAPI(testServer.Server.URL+"/content/suggest", testServer.Server.URL+"/content/suggest/__gtg", apiKey, http.DefaultClient)
...
func TestUmbrellaAPI_FetchDraftContentFailure(t *testing.T) {
	...
	contentAPI, err := NewUmbrellaAPI(testServer.Server.URL+"/content/suggest", testServer.Server.URL+"/content/suggest/__gtg", apiKey, http.DefaultClient)
	assert.NoError(t, err)
