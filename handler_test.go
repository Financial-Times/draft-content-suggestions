...
func TestRequestHandlerSuccess(t *testing.T) {
	...
	umbrellaAPI, _ := suggestions.NewUmbrellaAPI(umbrellaTestServer.Server.URL, umbrellaTestServer.Server.URL+"/__gtg", "12345", http.DefaultClient)
...
func TestRequestHandlerDraftContentSLATimeout(t *testing.T) {
	...
	umbrellaAPI, _ := suggestions.NewUmbrellaAPI(umbrellaTestServer.Server.URL+"/content/suggest", umbrellaTestServer.Server.URL+"/content/suggest/__gtg", "12345", http.DefaultClient)
...
func TestRequestHandlerUmbrellaApiSLATimeout(t *testing.T) {
	...
	contentAPI, _ := draft.NewContentAPI(draftContentTestServer.Server.URL+"/drafts/content", draftContentTestServer.Server.URL+"/__gtg", fthttp.NewClientWithDefaultTimeout("", ""))
	umbrellaAPI, _ := suggestions.NewUmbrellaAPI(umbrellaTestServer.Server.URL+"/content/suggest", umbrellaTestServer.Server.URL+"/content/suggest/__gtg", "12345", fthttp.NewClientWithDefaultTimeout("", ""))
